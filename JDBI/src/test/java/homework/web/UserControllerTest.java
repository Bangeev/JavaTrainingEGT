...
class UserControllerTest {
    ...
    @MockBean
    private UserRepositoryJdbi userRepository;
    ...
    public void testCreateUser() throws Exception {
        ...
        when(mockUserService.createUser(any(User.class))).thenReturn(Optional.of(MOCK_CREATED_USER));
    ...
    public void testUpdateUser() throws Exception {
        ...
        when(mockUserService.updateUser(any(User.class))).thenReturn(Optional.of(MOCK_USER));
    ...
    void whenCreatingUserButIsWithWrongDataThrowException() throws Exception {
        ...
        when(mockUserService.createUser(any(User.class))).thenReturn(Optional.of(MOCK_USER));
    ...
    public static final List<Recipe> MOCK_RECIPES = List.of(
            new Recipe(1L, 1L, "Recipe one", "Short Description", 60, PRODUCTS, "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Good_Food_Display_-_NCI_Visuals_Online.jpg/1280px-Good_Food_Display_-_NCI_Visuals_Online.jpg", "Long description", "intro", LocalDateTime.now(), LocalDateTime.now()),
            new Recipe(2L, 1L, "Recipe two", "Short Description", 60, PRODUCTS, "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Good_Food_Display_-_NCI_Visuals_Online.jpg/1280px-Good_Food_Display_-_NCI_Visuals_Online.jpg", "Long description", "python", LocalDateTime.now(), LocalDateTime.now())
    );
    ...
    public static final Recipe MOCK_RECIPE = new Recipe(1L, 1L, "Recipe one", "Short Description", 60, PRODUCTS, "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Good_Food_Display_-_NCI_Visuals_Online.jpg/1280px-Good_Food_Display_-_NCI_Visuals_Online.jpg", "Long description", "intro", LocalDateTime.now(), LocalDateTime.now());
